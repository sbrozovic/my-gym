...
public class TariffRecyclerViewAdapter extends RecyclerView.Adapter<TariffRecyclerViewAdapter.MyViewHolder> {
    ...
    public TariffRecyclerViewAdapter(List<Tariff> list, EditPriceListActivity editPriceListActivity){
        this.list = list;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                editPriceListActivity.runDialogDeleteEditTariff(list.get(position));
            }
        });
    }
