...
public class BossStartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boss_start);
        ...
        bundle.putString("Members_opened", "boss");
        MembersFragment membersFragment = new MembersFragment();
        membersFragment.setArguments(bundle);
        FragmentManager fm = getSupportFragmentManager();
        fm.beginTransaction().replace(R.id.frameBoss, membersFragment, CURRENT_FLAG).commit();
    ...
    private void setBottomNavigationListener() {
        bottomNavigation.setOnTabSelectedListener(new AHBottomNavigation.OnTabSelectedListener() {
            ...
            public boolean onTabSelected(int position, boolean wasSelected) {
                ...
                switch (position) {
                    case 0:
                        bundle.putString("Price_opened", "boss");
                        priceListFragment = new PriceListFragment();                        priceListFragment.setArguments(bundle);
                        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
                        ft.replace(R.id.frameBoss, priceListFragment, CURRENT_FLAG).commit();
                        CURRENT_FLAG = TAG_PRICE;
                        break;
                    case 1:
                        bundle.putString("Staff_opened", "boss");
                        staffFragment = new StaffFragment();
                        staffFragment.setArguments(bundle);
                        fm = getSupportFragmentManager();
                        fm.beginTransaction().replace(R.id.frameBoss, staffFragment, CURRENT_FLAG).commit();
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        bundle.putString("News_opened", "boss");
                        newsFragment = new NewsFragment();
                        newsFragment.setArguments(bundle);
                        fm = getSupportFragmentManager();
                        fm.beginTransaction().replace(R.id.frameBoss, newsFragment, CURRENT_FLAG).commit();
                        CURRENT_FLAG = TAG_NEWS;
                        break;
                    case 4:
                        bundle.putString("Info_opened", "boss");
                        aboutUsFragment = new AboutUsFragment();
                        aboutUsFragment.setArguments(bundle);
                        fm = getSupportFragmentManager();
                        fm.beginTransaction().replace(R.id.frameBoss, aboutUsFragment, CURRENT_FLAG).commit();
